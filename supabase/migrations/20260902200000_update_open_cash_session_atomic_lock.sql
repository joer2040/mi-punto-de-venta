-- Sprint 2B M1: Unificar clave de advisory lock en open_cash_session_atomic.
-- Cambia 'public.open_cash_session_atomic' → 'public.cash_session_atomic'
-- para serializar con record_first_cash_count_atomic y submit_cash_recount_atomic.
-- Sin cambio funcional ni de contrato.
...
begin
  ...
  -- Lock compartido con todos los RPCs de caja
